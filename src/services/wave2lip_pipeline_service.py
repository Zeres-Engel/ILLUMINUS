"""
Wave2Lip Pipeline Service
Tích hợp face detection và Wave2Lip processing thành pipeline hoàn chỉnh
"""
...
try:
    ...
    from nota_wav2lip.video import AudioSlicer
...
class Wave2LipPipelineService:
    """Pipeline service tích hợp hoàn chỉnh cho Wave2Lip với face detection"""
    ...
    def __init__(self, 
        ...
        logger.info(f"Wave2LipPipelineService initialized with device: {device}")
